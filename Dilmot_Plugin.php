...
class Dilmot_Plugin extends Dilmot_LifeCycle {
    ...
    public function getOptionMetaDataInfo() {
        ...
        $aWpUserFields = Array(
            '0' =>'----', 
            'username' => __("User name","dilmot"),
            'email' => __("email","dilmot"),
            'display_name' => __('Display name',"dilmot"),
            'first_last_name' => __('First + Last name',"dilmot"),
        );
        ...
        return array(
            ...
            */
            ...
            'SetWpUserInQuestionForm' => array(
                'name' => __('Set Wp user in question form', 'dilmot'),
                'values' => false,
                'hint' => __('Set Wp User as name in the question form', 'dilmot'),
                'values' => $aWpUserFields,
                ),
